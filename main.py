...
# Path to cookies file (update this to where your cookies.txt is located)
COOKIES_FILE = "cookies.txt"  # Keep cookies.txt in same folder as main.py
...
class MusicBot:
    def __init__(self):
        # cookies.txt file path used here
        self.yt_opts = {
    ...
    async def download_youtube_audio(self, url):
        """Download and extract YouTube audio stream using cookies"""
        try:
...
async def search_youtube(query):
    """Search YouTube for a song using cookies"""
    try:
        ydl_opts = {
            'quiet': True,
            'no_warnings': True,
